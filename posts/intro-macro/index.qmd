...
fig.update_layout(
    title='PIB sob a ótica da produção: Ideal para visualizar tendências no longo prazo.<br><sup>Evolução dos componentes de produção do PIB desde 1996</sup>')

fig.update_yaxes(tickformat=".0%", title='Variação acumulada',
                 range=[-0.3, 1.5], nticks=4)
