...
fig.update_layout(
    title='A influência das commodities na produção brasileira<br>Exportações e Investimentos são os principais motores do crescimento.<br><sup>Evolução dos componentes de produção do PIB desde 1996</sup>')
...
Em 2008, o Brasil foi atingido pela crise financeira global. Proxímo desse período, podemos observar uma queda significativa nas Exportações Líquidas e um aumento nos Investimentos. 
