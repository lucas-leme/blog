...
Existem duas principais formas de estimar o PIB: Oferta e Demanda.

Nesse estudo, vamos utilizar analisar o PIB sob as duas óticas. Para isso, vamos utilizar os dados do IBGE que são disponibilizados via SIDRA [^1]
...
Analisando o historico dessazonalizado dos componentes do PIB na @fig-oferta, podemos observar que Investimentos e Exportações Líquidas são os itens mais voláteis, principalmente em momentos de crise. Por outro lado, o consumo e os gastos do governo são mais estáveis.
...
Durante os 2 primeiros mandatos do Lula, o Brasil passou por um período de forte crescimento econômico. Esse crescimento foi impulsionado por um aumento significativo dos preços das commodities [^2], que por sua vez, impulsionou o indicador de Exportações Líquidas.

Em 2008, o Brasil foi atingido pela crise financeira global. Proxímo desse período, podemos observar uma queda significativa nas Exportações Líquidas após o *boom das commodities* um aumento nos Investimentos. O Diante da crise o governo utilizou uma variadade de instrumentos para diminuir os impactos, dentre eles: linhas de crédito para exportações, redução de impostos e intervenções no mercado cambial [^3]. A nota distoante do perído foi a manutenção da taxa de juros por parte do Banco Central (Henrique Meirelles), com um alto diferencial de juros uma deterioração mais drástica das expectativas do agentes foi evitada. Em 2009, o crescimento da formação bruta de capital fixo (FBKI - Investimentos) contribui positivamente para o PIB.
...
# plot pib com e sem desasonalização
fig = make_fig()
...
fig.update_layout(
    title='PIB Dessazonalizado: Ideal para visualizar tendências no longo prazo.<br><sup>PIB Histórico do Brasil</sup>')
...
[^3]: Crise e perspectivas para a economia brasileira - 10.1590/s0103-40142017.31890013